    ...
    <div class="sixteen columns product-detail-cont">
        ...
        <div class="seven columns">
            ...
            <div class="product-actions">
                <div class="product-share"><span>Share:</span> <a href="" id="lnk-fb-share"></a><a href="mailto:?subject=Welcome to SAVILE ROW SOCIETY&body=Hello, %0D%0A%0D%0AI would like to recomment this product to you. Check out <?php echo Router::url( $this->here, true ); ?>." id="lnk-email"></a></div>
