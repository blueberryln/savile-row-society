    ...
    <div class="sixteen columns text-center">
        ...
        <div class="fifteen columns offset-by-half product-listing">
            <div class="mycloset-tabs text-center">
                <a href="<?php echo $this->webroot . 'closet/liked'; ?>" class="link-btn gray-btn">Liked Items</a>
                <a href="<?php echo $this->webroot . 'closet/purchased'; ?>" class="link-btn gold-btn">Purchased Items</a>
            </div>
            ...
            <!--<div class="three columns alpha row">
                <div class="product-block">
                    ...
                    <div class="product-list-image mosaic-block fade">
                        ...
                        <div class="mosaic-backdrop">
                            <img src="<?php echo $this->webroot .'files/products/18_1638326_Denim.jpg'; ?>" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="three columns alpha row">
                <div class="product-block">
                    ...
                    <div class="product-list-image mosaic-block fade">
                        ...
                        <div class="mosaic-backdrop">
                            <img src="<?php echo $this->webroot .'files/products/17_7547012_Socks.jpg'; ?>" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="three columns alpha row">
                <div class="product-block">
                    ...
                    <div class="product-list-image mosaic-block fade">
                        ...
                        <div class="mosaic-backdrop">
                            <img src="<?php echo $this->webroot .'files/products/14_7351074_Outerwear.jpg'; ?>" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="three columns alpha row">
                <div class="product-block">
                    ...
                    <div class="product-list-image mosaic-block fade">
                        ...
                        <div class="mosaic-backdrop">
                            <img src="<?php echo $this->webroot .'files/products/48_5_5LmFLAM713.jpg'; ?>" alt="" />
                        </div>
                    </div>
                </div>
            </div>
