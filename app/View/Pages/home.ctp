        ...
        <div class="product-content">
            ...
            <?php if($topOutfits): ?>
                ...
                <li>
                    ...
                    <div class="right_box">
                        <div class="box4"><img src="<?php echo HTTP_ROOT ?>files/products/<?php echo $outfit['OutfitItem'][3]['product']['Image'][0]['name']; ?>"/></div>  
                    ...
                    <div class="text-content" style="float:left; width:100%; height:auto; text-align:left;">
                        <p style="float:left; width:70%; padding:5px 0 15px 0; margin:0px;">
                            <span class="golden-heading">&nbsp;</span>
                        </p>
                        <?php 
                            $comment_count = count($outfit['OutfitComment']); ?>
                        <p style="float:right; width:auto;  padding:5px 0 15px 0; margin:0px;cursor:pointer">
