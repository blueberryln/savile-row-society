            ...
            <div class="twelve columns container left message-box">
                <div class="eleven columns container pad-none">
                    <div class="twelve columns message-box-heading pad-none">
                        <h1>Kyle Harper | <span>Refer A friend</span></h1>
                    ...
                    <div class="twelve columns left inner-content pad-none">
                        <div class="inner-left left">
                            ...
                            <div class="right-pannel right">
                                <div class="twelve columns message-area refer-area left pad-none">
                                    <div class="eleven columns container pad-none">
                                        <div class="twelve columns left refer-frnd pad-none">
                                            <div class="eleven columns container pad-none">
                                                <div class="twelve columns left refer-frnd-area pad-none">
