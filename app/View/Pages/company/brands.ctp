...
", "id" => "19"),
    ...
    "hickies" => array("title" => "", "desc" => "HICKIES is an elastic lacing system that replaces traditional shoelaces and lets you easily slip in and out of your shoes while keeping them snug and secure. Never tie or untie your shoes again! Get rid of the bows and customize your footwear.", "id" => "46"),
    ...
    "Calida" => array("title" => "CALIDA", "desc" => "CALIDA is one of the leading bodywear brands in Europe and has it HQ in Sursee, Switzerland.  Since 1941 the company has been synonymous with premium quality in the best tradition of Swiss craftsmanship: superb, natural fabrics, classic and modern design, and excellent workmanship for perfect fit and exceptional comfort.CALIDA makes bodywear for those who value superb quality and want to feel comfortable in their skin – at work, at home, at leisure, indoors and out.", "id" => "73"),
        ...
        <div class="eleven columns container brand-boxes">
            ...
            <div class="viewport">
                ...
                <ul id="branding-ptners">
                    ...
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/Cole_Haan_new.png" alt="Cole Haan" data-name="colehaan" /></li>
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/paulevans_new.png" alt="Paulevans" data-name="paulevans" /><span class="brand-divider"></span></li>
                    ...
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/7diamonds_new.png" alt="" data-name="7diamonds" /></li>
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/lacoste_new.png" alt="" data-name="lacoste" /><span class="brand-divider"></span></li>
                    ...
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/tateossian_new.png" alt="" data-name="tateossian" /></li>
                    
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/edward-armah.jpg" alt="" data-name="edwardamrah" /><span class="brand-divider"></span></li>
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/gents.jpg" alt="" data-name="gents" /><span class="brand-divider"></span></li>
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/margo-petitti.jpg" alt="" data-name="margopetite" /></li>
                    
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/haspel.jpg" alt="" data-name="Haspel" /><span class="brand-divider"></span></li>
                    ...
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/saxx.jpg" alt="" data-name="saxx" /></li>
                    
                    <li><img src="<?php echo $this->webroot; ?>images/branding-partners/souther-proper.jpg" alt="" data-name="pepper" /><span class="brand-divider"></span></li>
