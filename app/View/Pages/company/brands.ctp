...
", "id" => "19"),
    ...
    "allanpaine" => array("title" => "", "desc" => "Alan Paine, whose roots date back to 1907, has established a worldwide reputation for quality knitwear, creating evolutionary style rather than revolutionary fashion.", "id" => "42"),
    ...
    "bensherman" => array("title" => "", "desc" => "Ben Sherman is a British based clothing company, designing shirts, suits, shoes, accessories, and other items that are, in common with many British brands, now made overseas, largely in the Far East.", "id" => "56"),
    "billskhakis" => array("title" => "", "desc" => "Bills Khakis Are Proudly Crafted In The USA. As fascinated as we are with the future, our hearts lie in the past. Old movies, books and vintage photographs are places we go to connect.", "id" => "44"),
    "camper" => array("title" => "", "desc" => "Camper is a shoe company based in Spain. Lorenzo Fluxà Rosselló founded the company in 1975 after inheriting a shoe factory from his father, Antoni Fluxà, a Majorcan shoemaker. Camper collection of exclusive footwear provides style and comfort for truly extraordinary shoes.", "id" => ""),
    ...
    "hook" => array("title" => "", "desc" => "The dapper duo breathed life back into men's contemporary accessories, beginning with the ones that brought these old pals back together - the dress sock. why hook + ALBERT you ask? well, it relates back to the beloved + luxurious mens accessory: the pocket watch.  because the watch itself was kept in the breast pocket of the waistcoat + out of site, a man's only option to bring life to this treasured gem was through the use of the chain also known as an \"albert\". The \"albert\" was attached to the waistcoat using the \"hook\". Hence, hook + ALBERT.", "id" => "48"),
    "hudson" => array("title" => "", "desc" => "Hudson Jeans purpose is to inspire people to live their dreams, look and feel amazing, and to be real.", "id" => "49"),
    "lna" => array("title" => "", "desc" => "LNA was launched in 2007 by California natives Lauren Alexander and April Leight. Beginning with the idea of creating the perfect men’s inspired t-shirt for women, LNA has since evolved into producing full, seasonal collections. Offering everything from your favorite tees to leather jackets and cashmere sweaters, the collection is always inspired by life on the west coast. LNA has a very loyal following of celebrities from Kate Moss to Ryan Gosling and has been featured in major fashion magazines such as Vogue, Elle and Harpers Bazaar.", "id" => "40"),
