            ...
            <div class="blank-space">&nbsp;</div>
                <div class="eleven columns container aboutus">
                    ...
                    <div class="twelve columns page-content aboutus-content">
                        ...
                        <p>
                            Welcome to the Web site (the “Site”) of Savile Row Society, Inc. (collectively with its affiliates, <strong>“Savile Row Society”</strong>, “SRS”, “we”, “us” and/or “our”). This Site is operated by Savile Row Society and has been created to provide information about our company and its services (together with the Site, the “Service(s)”) to our Service visitors (“you”, “your”). This notice describes our policy with respect personally identifiable and other information that is collected from visitors to the Site and Services. By visiting the Site or interacting with the Services, you are accepting the practices described in this Privacy Notice.
                        </p>

                        <h3>What information does Savile Row Society collect?</h3>
                        ...
                        <p>
                            We receive and store certain types of information whenever you interact with us, which is collected passively using various technologies.
                            <br>
                            For example, like many Web sites, we use “cookies,” and we obtain certain types of information when your Web browser accesses savilerowsociety.com. Such information cannot presently be used identify you personally. If associated with other information such you can be identified personally, such information would be treated as personally identifiable information hereunder.
                            <br>
                        ...
                        <h3>How does Savile Row Society use personally identifiable and other information?</h3>
                        <p>
                        ...
                        <h3>Does Savile Row Society share personally identifiable information?</h3>
                        <p>
                        ...
                        <p>
                            We work to protect the security of your information during order transmission by using Secure Sockets Layer (SSL) software, which encrypts order information you transmit. We reveal only the last five digits of your credit card numbers when confirming an order.
                            <br>
                            Of course, we transmit the entire credit card number to the appropriate credit card company during order processing. It is important for you to protect against unauthorized access to your password and to your computer. Be sure to sign off when finished using a shared computer.
                         </p>

                        <h3>What about links to other Web sites?</h3>
                        <p>
                        ...
                        <p>
                            <strong>Savilerowsociety.com</strong> gives you access to information about your account and your interactions with <strong>Savilerowsociety.com</strong> for the limited purpose of viewing and, in certain cases, updating that information.
                        </p>

                        <h3>What choices do I have?</h3>
                        <p>
                            You can always choose not to provide information, even though it might be needed to make a purchase. If you do not want to receive e-mail or other mail from us, please contact us at <strong>admin@savilerowsociety.com</strong>.
                        </p>
                        ...
                        <h3>Are children allowed to use Savile Row Society and Savilerowsociety.com?</h3>
                        <p>
                        ...
                        <p>
                            One of the special features of the Service is that it may allow you to enable or log in to the Service via various social networking services like Facebook (“Social Networking Service(s)”). By directly integrating these Social Networking Services, we make your online experiences richer and more personalized. To take advantage of this feature, we would ask you to log into the relevant Social Networking Service. 
                            <br>
                            If you add a Social Networking Services account to the Service or log into the Service using your Social Networking Services account, we would collect relevant information necessary to enable the Service to access that Social Networking Service and your data contained within that Social Networking Service. As part of such integration, the Social Networking Service would provide us with access to certain information that you have provided to the Social Networking Service, and we would use, store and disclose such information in accordance with this Privacy Policy. 
                            <br>
                        ...
                        <p class="text-center">
                            <em class="font-big font-bold">Last updated: July 10, 2014</em> 
