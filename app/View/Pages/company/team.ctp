...
<div class="container content inner">
    ...
    <div class="fourteen offset-by-one columns crew text-justify">	
        <p>
            Savile Row Society consists of a growing team of menswear specialists, lifestyle fashionistas, finance moguls, technology geeks, product junkies, and fitness fanatics to bring men all the goods to work smarter, play harder, and feel better.
            <br/><br/>
        </p>
        <div class="team-member">
            ...
            <div class="ten columns">
                ...
                <div class="long-desc hide">
                    ...
                    <p>Today, Lisa likes to work long hours on SRS, trying out the best bars and restaurants New York City has to offer. She also competes athletically, participating in both duathlons (cyclinc and running) and triathlons (swimming, cycling, and running). She looks forward to seeing you on the starting line as a member of Savile Row Society, Inc.</p>
                </div>
        ...
        <div class="team-member">
            ...
            <div class="ten columns">
                ...
                <div class="long-desc hide">
                    ...
                    <div>
                        <iframe width="460" height="315" src="http://www.youtube.com/embed/ZIeZdN1rYAQ?rel=0" frameborder="0" allowfullscreen></iframe>
                        <br /><br />
                    </div>
                </div>
                <div class="text-center">
