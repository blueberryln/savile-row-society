    ...
    <div class="sixteen columns">
        <div class="users index">
            <table cellpadding="0" cellspacing="0">
                ...
                <?php
                    //print_r($Stylsts);
                 foreach ($Stylsts as $stylist): ?>
                 
                    <tr class="user-row">
                        <td><?php echo $stylist['User']['id']; ?>&nbsp;</td>
                        <td><?php echo $stylist['User']['email']; ?>&nbsp;</td>
                        <td><?php echo $stylist['User']['first_name']; ?>&nbsp;</td>
                        <td><?php echo $stylist['User']['last_name']; ?>&nbsp;</td>
                        <td><?php echo $stylist['User']['location']; ?>&nbsp;</td>
                        <td><?php echo $stylist['User']['zip']; ?>&nbsp;</td>
