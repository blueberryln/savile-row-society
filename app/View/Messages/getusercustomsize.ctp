    		...
    		<h1 class="text-center">Custom Shirt Measurements</h1>
			    ...
			    <div class="five columns pref-time right">
			        <div class="pref-options">
						...
						Posture :<input type="text" name="data[UserSizeInformation][custom_jacket_measurement][posture]">
						<br>
						<br>
						<br>
						<br>
			    ...
			    <div class="five columns pref-time right">
			        <div class="pref-options">
			            ...
			            Bottom :<input type="text" name="data[UserSizeInformation][custom_trouser_measurement][bottom]">
					</div>
			    </div>
