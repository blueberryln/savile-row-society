                    ...
                    <div id="step-1">
                        ...
                        <div class="ten columns my-cart center-block">
                            <?php if ($cart_list) : ?>
                                ...
                                <input type="hidden" name="checkout-cart-id" value="" />
                        ...
                        <div class="contact-container billing-shipping ten columns center-block" id="billing-data">
                            ...
                            <div class="srs-form columns five right">
                                <div class="form form1">   
                                     ...
                                     <div class="input text required">
                                         <?php
                                            echo $this->Form->input('billemail', array('label'=>'Email', 'id'=>'billEmail', 'maxlength'=>'255', 'tabindex'=>'8'));
                                         ?>
                                     </div>
