        ...
        <tr>
            <td style="border-top: 1px solid #CFCFCF; border-bottom: 1px solid #CFCFCF; padding: 0px 15px; color: #595959">
                ...
                <div style=" padding: 5px 0;">
                    <p >Thank you for registering with Savile Row Society. Due to high demand in our beta period, we have placed you on our waitlist and will notify you as soon as we are able to service you.</p>
                </div>

                <p style="margin-bottom: 10px; margin-top: 15px;">Kindest Regards,<br>
                The SRS Team</p>
                <br>
            </td>        
        </tr>
