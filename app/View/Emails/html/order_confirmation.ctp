    ...
    <table cellspacing="0" cellpadding="0" style=" width: 640px; margin: 5px auto; text-align: left; background-color: #ffffff;">
        ...
        <tr>
            <td style="border-top: 1px solid #CFCFCF; border-bottom: 1px solid #CFCFCF; padding: 0px 15px; color: #595959">
                ...
                <p style="padding-top: 15px;">Hi <?php echo ucwords($shipped_order['User']['first_name']); ?>,</p>

                <div style=" padding: 5px 0;">
                    <p >Thank you for your purchase. We have received your order and will be processing it right away. You should be receiving a shipping confirmation email shortly. Please do not hesitate to reach out to your stylist or email us at <a href="mailto:contactus@savilerowsociety.com">contactus@savilerowsociety.com</a> with any questions or concerns.</p>
                    <br>
                </div>
