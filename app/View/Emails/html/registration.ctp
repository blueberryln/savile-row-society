<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    ...
    <tr>
        <td valign="top"> 
            ...
            <br/><br/>
            <a href="http://savilerowsociety.com/stylist">http://savilerowsociety.com/stylist</a>
            <br/><br/>
            ...
            <h2 style="text-align:center;">Now offering First Mover Advantage!<br/>FIRST MOVER BETA GROUP $0.00</h2>
        </td>
    </tr>
</table>
