        ...
        <tr>
            <td style="border-top: 1px solid #CFCFCF; border-bottom: 1px solid #CFCFCF; padding: 0px 15px; color: #595959">
                ...
                <div style=" padding: 5px 0;">
                    <p >Thank you for signing up for Savile Row Society. Once you have completed your <a href="http://www.savilerowsociety.com/profile/about">Style Profile</a>, your personal stylist will be able to work with you to create your ideal wardrobe.</p>
                </div>
