    ...
    <table cellspacing="0" cellpadding="0" style=" width: 640px; margin: 5px auto; text-align: left;background-color: #ffffff;">
        ...
        <tr>
            <td style="border-top: 1px solid #CFCFCF; border-bottom: 1px solid #CFCFCF; padding: 0px 15px; color: #595959">
                ...
                <p style="padding-top: 15px;">Hi <?php echo ucfirst($contact['first_name']); ?>,</p>

                <div style=" padding: 5px 0;">
                    <p >Thank you for reaching out to us. We will be following up with you shortly in regards to your recent inquiry.</p>
                    <p>Content of the message:<br>
                        <?php echo $contact['first_name']; ?>
                    </p>
                </div>

                <p style="margin-bottom: 10px;">Best,<br>
