...
$profileLinkScript = '';
$scriptProfile = '';
if(!isset($registerSharePopup) && isset($profilePopup) && $profilePopup['completeProfile'] && ($this->params['controller'] != 'closet' || ($this->params['controller'] == 'closet' && $this->params['action'] != 'index'))){
