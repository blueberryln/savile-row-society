            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <?php foreach ($styles as $style): ?>
                    <tr class="user-row">
                        ...
                        <td><?php echo $style['Style']['image']; ?>&nbsp;</td>
                        <td><?php echo $style['Style']['order']; ?>&nbsp;</td>
                         <td><?php echo $style['Style']['status']; ?>&nbsp;</td>
                         <td><?php echo $style['Style']['created']; ?>&nbsp;</td>
                        ...
                        <td class="actions">
                           ...
                           <?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $style['Style']['id']),null, sprintf('Are you sure you want to delete %s?', $style['Style']['name'])); ?>
                        </td>
