<div class="col-md-12">
  ...
  <div class="box box-primary">
    <div class="box-header">
      <h3 class="box-title">Add Outfit Comments</h3>
    ...
    <form role="form" method="post" enctype ="multipart/form-data">
      <div class="box-body">
        <div class="form-group">
          ...
          <select required name="stylist" class="form-control select_stylist">
        ...
        <div class="form-group">
          ...
          <input type="text" name="data[OutfitComment][comment]" required class="form-control" placeholder="Enter comment">
        </div>
        <div class="form-group">
          <label>Status</label>
