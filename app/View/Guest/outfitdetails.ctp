...
$(document).ready(function(){  
    ...
    $(".product-add-cart").on("click", function(e) {
        ...
        $.post("/api/guest/save", { product_id: id, product_quantity: quantity, product_size: size, outfit_id: outfitId },
            function(data) {
            ...
            <div class="twelve columns container left message-box">
                <div class="eleven columns container pad-none">
                    <div class="twelve columns message-box-heading pad-none">
                        <h1><span>Outfit Detail</span></h1
>                    </div>

                    <div class="inner-left left">
                        <div class="twelve columns inner-content pad-none">
                            <div class="right-panel product-detials">
